...
#         self.model.eval()
#         with torch.no_grad():
#             for i, (batch_x, batch_y, batch_x_mark, batch_y_mark,batch_day) in enumerate(vali_loader):
...
#             for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_day) in enumerate(train_loader):
#                 iter_count += 1
...
#         with torch.no_grad():
#             cnt = 0
#             for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_day) in enumerate(test_loader):
#                 batch_x = batch_x.float().to(self.device)
...
#                 auto_result.append([true_result,pred_result,acc])
...
class Exp_Main_xwj(object):
    def xwj(self):
        return '22222222222222222222222222222222222'
